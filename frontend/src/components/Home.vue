      ...
      <div class="container px-4 px-lg-5">
        <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
          <div class="col-xl-8 col-lg-7">
            <img class="img-fluid mb-3 mb-lg-0" src="../assets/pic2.jpg" alt="..." />
          </div>
          <div class="col-xl-4 col-lg-5">
            <div class="featured-text text-center text-lg-left">
              <h4>WOMAN</h4>
              <p class="text-black-50 mb-0">
                Embrace your individuality and express your unique sense of fashion with our diverse range of women's clothing.
                From bold patterns and vibrant colors to timeless classics and contemporary designs, our collection caters to a wide range of styles and preferences.
              </p>
            </div>
          </div>
        </div>
        <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
          <div class="col-lg-6">
            <img class="img-fluid" src="../assets/kidszara.jpg" alt="..." />
          </div>
          <div class="col-lg-6">
              ...
              <div class="d-flex h-100">
                <div class="project-text w-100 my-auto text-center text-lg-left">
                  ...
                  <p class="mb-0 text-white-50">
                    Collection of kids' clothes! From playful patterns to vibrant colors, we have everything your little ones need to express their unique style.
                    Our clothes are designed with comfort and durability in mind, ensuring that your kids can play, explore, and create lasting memories in style.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="row gx-0 justify-content-center">
          <div class="col-lg-6">
            <img class="img-fluid" src="../assets/man.jpg" alt="..." />
          </div>
          <div class="col-lg-6 order-lg-first">
            <div class="bg-black text-center h-100 project">
              <div class="d-flex h-100">
                <div class="project-text w-100 my-auto text-center text-lg-right">
                  <h4 class="text-white">MAN</h4>
                  <p class="mb-0 text-white-50">
                    Discover the perfect blend of style and comfort with our collection of men's clothing.
                    From casual t-shirts and jeans to tailored suits and dress shirts, our range offers versatile options for every occasion.
                    Stay on-trend with our carefully curated selection of men's fashion, designed to elevate your wardrobe and showcase your personal style.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <div class="card py-4 h-100">
              <div class="card-body text-center">
                ...
                <div class="small text-black-50">Elgazala Technopark, Bloc B24, Raoued</div>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-3 mb-md-0">
            <div class="card py-4 h-100">
              <div class="card-body text-center">
                ...
                <hr class="my-4 mx-auto" />
                <div class="small text-black-50"><a href="mailto:ZARA@gmail.com">ZARA@gmail.com</a></div>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-3 mb-md-0">
...
.navbar-collapse {
  ...
  flex-grow: 1;
  align-items: center;
  transform: translate(157px, -25px);
}
